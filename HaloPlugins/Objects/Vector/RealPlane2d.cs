...
{
    public class RealPlane2d : MetaNode
    {
        ...
        public RealPlane2d(string name) 
            : base(name, FieldSize, FieldType.RealPlane2d, EngineManager.HaloEngine.Neutral)
        {
        ...
        {
            RealPlane2d v = new RealPlane2d(this.Name);
            v.X = this.X;
            v.Y = this.Y;
            v.Z = this.Z;
            return v;
        ...
        {
            return "RealPlane2d: " + Name + ", X: " + X.ToString() + ", Y: " + Y.ToString() + ", Z: " + Z.ToString();
        }
